...
def clean_language(lang_raw):
    lang_english = safe_translate(lang_raw, 'english').lower()
    if lang_english in SUPPORTED_LANGUAGES:
        return lang_english
    for supported in SUPPORTED_LANGUAGES:
        if lang_english in supported or supported in lang_english:
            return supported
    return lang_english
...
user_lang = clean_language(user_lang_raw)
#---------------------------------------------------------------------------------------------
